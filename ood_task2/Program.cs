...
namespace Task2
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // 
            Iteration.BFS(root);
            var printableContent = root.GetPrintableContent();
            ...
            // 
            Iteration.DFS(root);
            var _printableContent = root.GetPrintableContent();
            if (_printableContent != null)
            {
                //Iteration.printTransformedDFS(root);
                Console.WriteLine(_printableContent);
            }
            // Make sure that:
